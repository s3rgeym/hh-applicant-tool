...
class TelemetryClient:
    ...
    def __init__(self, server_address: Optional[str] = None, session: Optional[requests.Session] = None) -> None:
        """
        ...
        self.server_address = os.getenv('TELEMETRY_SERVER', server_address or self.server_address)
      
    def send_telemetry(self, endpoint: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
