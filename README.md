...
- 🧩 **Выполнение тестов при отклике**. Часто для того чтобы откликнуться на вакансию нужно выполнять тест. Если читать эти тесты, то можно высрать кирпичей от тупости вопросов, которые там задают овчарки... Типа какие ваши зарплатные ожидания или имели вы опыт с технологией X и тп. Это, блять, все в резюме написано! Утилита подставляет рандомные данные в качестве ответов при отклике, избавляя вас от чтения этой хуйни (никто на них ответы не проверяет, они нужны лишь для борьбы с примитивными ботами для откликов). 
