...
| **clear-negotiations** | При рассылке массовых заявок, отклики и приглашения забиваются отказами, либо заявки висят месяцами пока ленивая херка их не просмотрит |
