...
- `--profile <profile-id>` имя текущего профиля, подкаталога в каталоге с конфигурациями.
...
| **negotiations**   | Проверятет отклики и выводит приглашения, а так же опционально может отменять отклики                                                                                        |
...
$ hh-applicant-tool --profile fake authorize
...
$ hh-applicant-tool negotiations -r report.csv

# Чистим заявки и баним за отказы говноконторы
$ hh-applicant-tool negotiations --clean --blacklist-discard
