...
$ hh-applicant-tool sync-negotians
...
| Операция                           | Описание                                                                                                                                                                                                                        |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **authorize**, **auth**            | Авторизовываться на hh.ru                                                                                                                                                                                                       |
...
| **query**                          | Выполнение SQL-запросов к базе. Схема БД находится в файле   [schema.sql](./hh_applicant_tool/storage/queries/schema.sql). Если скормить ее [DeepSeek](https://chat.deepseek.com/sign_in), то он поможет написать любой запрос. |
