...
- 🔒 **Ваши данные в безопасности.** Ваши телефон, пароль, резюме и другие персональные данные никуда не передаются в отличии от сторонних сервисов. Если данная утилита и собирает телеметрию, то **СОБИРАЕТСЯ ТОЛЬКО ТЕЛЕМЕТРИЯ РАБОТОДАТЕЛЕЙ ИХ КОНТАКТЫ И ДАННЫЕ О ВАКАНСИЯХ И КОМПАНИИ — ВСЕ**. Мало того, вы можете всегда ее удалить. В этом можно убедиться, изучив ее [открытый исходный код](https://github.com/s3rgeym/hh-applicant-tool/tree/main/hh_applicant_tool). Владельцы сторонних сервисов никогда вам его не покажут. Они знают о вас все и эти данные спокойно продадут каким-нибудь жуликам, либо оно утекут в результате взлома.
