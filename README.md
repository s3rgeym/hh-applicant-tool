...
| **query**                          | Выполнение SQL-запросов к базе. Схема БД находится в файле   [schema.sql](./hh_applicant_tool/storage/queries/schema.sql). Если скормить ее [DeepSeek](https://chat.deepseek.com), то он поможет написать любой запрос. |
