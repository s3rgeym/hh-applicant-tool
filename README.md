...
> [!NOTE]
> Взамен этой утилиты советую использовать [HH AI Responder](https://github.com/s3rgeym/hh-ai-responder/tree/main) — это программа, написанная на Go под Linux, Mac, Windows и Android, которая автоматически рассылает отклики и общается с хрюшами и кабанычами через ХуИИ. 
