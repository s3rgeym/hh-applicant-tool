...
> [!NOTE]
> Попробуйте так же [HH AI Applier](https://github.com/s3rgeym/hh-ai-applier/tree/main) — упрощенную версию данной утилиты, представляющую собой программу, написанную на Go и статически-собранную, не требующую питон и прочие зависимости, которая поддерживает Linux, Mac, Windows и Android. 
