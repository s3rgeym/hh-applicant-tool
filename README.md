...
- 🔒 **Ваши данные в безопасности.** Телефон, пароль, резюме и другие персональные данные никуда не передаются и обрабатываются только на вашем устройстве. Владельцы сторонних сервисов не могут этого гарантировать, и в случае взлома их серверов, ваши данные станут достоянием общественности. Данная утилита, если и собирает телеметрию, то она касается только данных о работодателях для выявления мошенников, и вам ничто не угрожает. Мало того, вы можете всегда ее удалить. В этом можно убедиться, изучив ее [открытый исходный код](https://github.com/s3rgeym/hh-applicant-tool/tree/main/hh_applicant_tool) (владельцы сервисов никогда вам его не покажут).
