...
| **get-employer-contacts** | Получить список контактов работодателя, даже если тот не высылал приглашения. Данная функция готова и будет доступна после 100 ⭐  |
...
1. Контактная информация работодателя, которую он или его сотрудники сами выложили в общественный доступ (может быть удалена при письменном запросе в утвержденной форме с оригинальными печатями фирмы и росписью генерального директора и/или требованию РКН).
1. Название компании.
1. Тип компании.
1. Описание компании.
