...
| `vacancy_test_answer` | Ответ на вопрос из теста. Можно использовать синтаксис шаблонов, например, `Увольте того { идиота | придурка }, который придумал этот { тупой | сраный | дурацкий } вопрос.`. |
