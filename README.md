...
> [!WARNING]
> Мой проект полностью бесплатен для личного пользования, для коммерческого использования ОН ЗАПРЕЩЕН, однако находятся отдельные ублюдки, которые используют МОЮ РАЗРАБОТКУ в коммерческих целях. Мною были обнаружены сл уебаны: hintsgage хуИИ, sobes tech и др. Как спалились? - Мой скрипт аналоговнентный и как только я в нем реализовал мультиакки, так сразу они появились у этих козлов, сделал автоматическое решение тестов, у них они тоже появились. Эти гандоны или пиздят мой код частично, либо тупо утилиту встроили в свои говносервисы. Я их проклинаю в веках и желаю им всего плохого. Если где увидите где ссылку на них, в отзывах каких, то кидайте ссылку на этот скрипт и пишите, что эти твари продают ХАЛЯВУ.
