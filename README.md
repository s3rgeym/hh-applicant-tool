...
| **reply-chats**, **reply**               | Ответить во все чаты с работодателями, где нет ответа либо не прочитали ваш предыдущий ответ                                                                                 |
| **check-negotiations**, **negotiations** | Проверяет отклики, а так же может их отменять                                                                                                                                |
