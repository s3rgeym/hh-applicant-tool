...
Если же авторизация не происходит при вводе правильных данных для авторизщации, то скорее всего требуется ввод капчи, чтобы авторизоваться через всплывающее окно:
