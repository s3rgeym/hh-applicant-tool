...
`custom` - полный контекст вакансии и резюме, но со своим системным промптом через `--ai-filter-prompt` (анализ резюме добавляется в конец промпта блоком «Кандидат»)
