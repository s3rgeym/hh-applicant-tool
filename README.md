...
* [📦 Установка](#установка)
    * [Установка в Windows](#отдельно-я-распишу-процесс-установки-в-windows-в-подробностях)
    * [Linux / macOS](#традиционный-способ-для-linuxmac)
