...
> [!NOTE]
> Настоящие погромисты пишут только в <s>блокноте</s> <s>vim</s> neovim. ЗАЦЕНИТЕ МОЙ [КОФИГ NEOVIM](https://github.com/s3rgeym/nvim-config) НА КОТОРОМ Я ФАКТИЧЕСКИ РЕДАКТИРУЮ ВЕСЬ КОД, УДАЛИВ ДАВНО VS CODE И ПР ЗАЛУПУ!!!
